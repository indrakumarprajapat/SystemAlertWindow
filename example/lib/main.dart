  ...
  void _showOverlayWindow() {
    // if (!_isShowingWindow) {
      SystemWindowHeader header = SystemWindowHeader(
          ...
          subTitle: SystemWindowText(text: "7777777777", fontSize: 14, fontWeight: FontWeight.BOLD, textColor: Colors.black87),
      ...
      SystemAlertWindow.showSystemWindow(
          ...
          body: body,
          footer: footer,
          margin: SystemWindowMargin(left: 8, right: 8, top: 70, bottom: 0),
